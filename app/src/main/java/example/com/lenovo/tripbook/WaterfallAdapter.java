...
public class WaterfallAdapter extends ArrayAdapter<String> {
    ...
    public WaterfallAdapter(final Context context, final int textViewResourceId) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        ViewHolder vh;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.waterfall_item, parent, false);
            vh = new ViewHolder();
