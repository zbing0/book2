...
public abstract class ExtendableListView extends AbsListView {
    ...
    /**
     * MainPageActivity class that represents a fixed view in a list, for example a header at the top
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (!isEnabled()) {
            // MainPageActivity disabled view that is clickable still consumes the touch
...
//            case TOUCH_MODE_OVERSCROLL:
     ...
     * @return MainPageActivity view displaying the data associated with the specified position
     */
     ...
     * MainPageActivity FlingRunnable will keep re-posting itself until the fling is done.
     */
    ...
    class RecycleBin {
        ...
        /**
         * @return MainPageActivity view from the ScrapViews collection. These are unordered.
         */
...
//        }
    ...
    /**
     * MainPageActivity base class for Runnables that will check that their view is still attached to
